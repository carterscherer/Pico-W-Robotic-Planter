#############################################################################
#                                                                           #
#    B O O T       MOTHER HOME TECH.                    RUN ON SOL 1.0.0    #
#                                                                           #
#############################################################################

# This program will be saved on the Pico W running the anvil firmware (more infor in read me)
# This program will run first on boot

import wisecretfi

##############################################################

# W I F I   N E T W O R K   S E C R E T S 

 
# add a wifi secrets file
# WIFI_SSID = "<wifi ssid>"
